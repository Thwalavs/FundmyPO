    ...
    <main style={{fontFamily:'"Inter", sans-serif',color:'#1F2937'}}>
      ...
      <section style={{padding:'5rem 2rem',background:'#fff'}}>
        <div style={{maxWidth:'900px',margin:'0 auto'}}>
          <h2 style={{fontSize:'32px',fontWeight:'700',color:'#1F2937',marginBottom:'1.5rem'}}>Working Capital Solutions for South African SMEs</h2>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))',gap:'1.5rem',marginTop:'2rem'}}>
            {[
              ...
              <div key={title} style={{background:'#FAFAF8',border:'1px solid #e5e7eb',borderRadius:'14px',padding:'1.5rem'}}>
                <h3 style={{fontSize:'15px',fontWeight:'700',color:'#1F2937',marginBottom:'0.5rem'}}>{title}</h3>
