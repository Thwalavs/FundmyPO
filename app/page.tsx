        ...
        <div style={{maxWidth:'900px',margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:'1.5rem'}} className="four-col">
            {[
              ...
              { title:'Phone', value:'(810) 336-7870' },
              { title:'Website', value:'FundMyPO.com' },
              { title:'Location', value:'South Africa' },
            ].map(({title,value})=>(
        ...
        <div style={{maxWidth:'1100px',margin:'0 auto'}}>
          <div style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr',gap:'2rem',marginBottom:'2.5rem'}} className="footer-grid">
            ...
            <div>
              ...
              <p style={{fontSize:'13px',color:'rgba(255,255,255,0.5)',marginBottom:'.5rem',fontFamily:'Arial,sans-serif'}}>(810) 336-7870</p>
              <p style={{fontSize:'13px',color:'rgba(255,255,255,0.5)',marginBottom:'.5rem',fontFamily:'Arial,sans-serif'}}>FundMyPO.com</p>
