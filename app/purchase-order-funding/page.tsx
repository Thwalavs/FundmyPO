    ...
    <main style={{fontFamily:'"Inter", sans-serif',color:'#1F2937'}}>
      ...
      <section style={{background:'linear-gradient(135deg,#1F2937,#111827)',padding:'5rem 2rem',textAlign:'center'}}>
        <div style={{maxWidth:'800px',margin:'0 auto'}}>
          ...
          <div style={{display:'flex',gap:'1rem',justifyContent:'center',flexWrap:'wrap'}}>
            <Link href="/register" style={{background:'#0D7E7E',color:'#fff',padding:'14px 32px',borderRadius:'10px',textDecoration:'none',fontSize:'16px',fontWeight:'700'}}>
              Apply for PO Funding
            </Link>
            <Link href="/register?role=funder" style={{background:'transparent',color:'#fff',padding:'14px 32px',borderRadius:'10px',textDecoration:'none',fontSize:'16px',fontWeight:'600',border:'1px solid rgba(255,255,255,0.4)'}}>
              Become a Funder
            </Link>
          </div>
        </div>
      ...
      <section style={{padding:'5rem 2rem',background:'#fff'}}>
        <div style={{maxWidth:'900px',margin:'0 auto'}}>
          <h2 style={{fontSize:'32px',fontWeight:'700',color:'#1F2937',marginBottom:'1.5rem'}}>What is Purchase Order Funding?</h2>
      ...
      <section style={{padding:'5rem 2rem',background:'#FAFAF8'}}>
        <div style={{maxWidth:'900px',margin:'0 auto'}}>
          <h2 style={{fontSize:'32px',fontWeight:'700',color:'#1F2937',marginBottom:'3rem',textAlign:'center'}}>Who Qualifies for PO Funding?</h2>
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(250px,1fr))',gap:'1.5rem'}}>
            {[
              ...
              <div key={title} style={{background:'#fff',border:'1px solid #e5e7eb',borderRadius:'14px',padding:'1.5rem'}}>
                <h3 style={{fontSize:'16px',fontWeight:'700',color:'#1F2937',marginBottom:'0.75rem'}}>{title}</h3>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'2rem'}}>
            {[
              ...
              <div key={num} style={{textAlign:'center'}}>
                <div style={{width:'56px',height:'56px',background:'#0D7E7E',borderRadius:'14px',display:'flex',alignItems:'center',justifyContent:'center',margin:'0 auto 1rem',fontSize:'14px',fontWeight:'700',color:'#fff'}}>{num}</div>
      ...
      <section style={{padding:'5rem 2rem',background:'#fff'}}>
        <div style={{maxWidth:'900px',margin:'0 auto'}}>
          <h2 style={{fontSize:'32px',fontWeight:'700',color:'#1F2937',marginBottom:'2rem'}}>Frequently Asked Questions</h2>
          {[
            ...
            <div key={q} style={{borderBottom:'1px solid #e5e7eb',paddingBottom:'1.5rem',marginBottom:'1.5rem'}}>
              <h3 style={{fontSize:'16px',fontWeight:'700',color:'#1F2937',marginBottom:'0.75rem'}}>{q}</h3>
              <p style={{fontSize:'15px',color:'#4b5563',lineHeight:'1.8'}}>{a}</p>
            </div>
          ))}
        </div>
      </section>
